        ...
        for epoch in pbar:
            ...
            if epoch % self.log_epoch == 0:
                self.inference([self.static_data.feat_static_val.to(self.device), self.static_data.feat_static_test.to(self.device)],
                        ...
                        [self.static_data.pos_edges_l_static_val.to(self.device), self.static_data.pos_edges_l_static_test.to(self.device)],
                        [self.static_data.neg_edges_l_static_val.to(self.device), self.static_data.neg_edges_l_static_test.to(self.device)])
