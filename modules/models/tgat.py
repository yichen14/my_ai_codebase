...
class AttnModel(torch.nn.Module):
    ...
    def forward(self, src, src_t, seq, seq_t, seq_e, mask):
        ...
        # print(q.size()) # [200, 1, 516]
        # print(k.size()) # [200, 20, 516]
        ...
        attn = attn.squeeze()
        # print(output.size()) # [200, 516]
        # print(attn.size()) # [400, 20]
        # print(src.size()) # [200, 172]
        # x = torch.cat([output, src], dim=1)
        # print(x.size()) # [200, 688]
        # exit()
...
class TGAN(torch.nn.Module):
    def __init__(self, ngh_finder, n_feat, e_feat,
                 attn_mode='prod', use_time='time', agg_method='attn', node_dim=64, time_dim=64,
                 num_layers=2, n_head=2, null_idx=0, drop_out=0.1, seq_len=16):
